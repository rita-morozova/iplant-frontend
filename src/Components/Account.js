...
class Account extends Component {
    ...
    handleSubmit = (event) => {
        ...
        this.props.handleSubmit(this.state, `/users/${this.props.user.id}`, 'PATCH')
    }
                    ...
                    <Header as='h2' textAlign='center'>
                        ...
                        <Form className='signup-form' onSubmit={(event) => this.handleSubmit(event)} size='large'>
                            <Segment stacked>
                             ...
                             <Form.Input fluid placeholder='Phone' type='text' name='phone' value={this.state.phone} onChange={this.handleChange} /><br />
